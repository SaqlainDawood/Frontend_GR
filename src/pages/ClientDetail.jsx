...
const ClientDetail = () => {
  ...
  const verificationImage = client?.bankDetails?.verificationDocument
      ...
      <div className="client-detail-card">
        ...
        <div className="client-detail-grid">
          ...
          <div className="detail-section card-detail-section">
            ...
            <div className="detail-row">
              ...
              <span className="balance-amount">
                {client.cardDetails?.balance
                  ? `AED ${client.cardDetails.balance}`
                  : "N/A"}
              </span>
            </div>
          </div>
          ...
          <div className="detail-section full-width">
            <h3>
              <FaCalendar /> Registration Information
            </h3>
            <div className="detail-row">
